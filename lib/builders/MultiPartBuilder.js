...
var MultiPartBuilder = (function () {
    ...
    _createClass(MultiPartBuilder, [{
        ...
        value: function build() {
            if (this[_content]) this[_content] = Buffer.concat([this[_content], new Buffer(MULTIPART_MARK + _boundary + MULTIPART_MARK + LF, 'utf8')]);

            //var res:String = _content.toString();

            return _RequestBody2.default.create(this[_content], new MimeBuilder().contentType(this[_type] + ";boundary=" + _boundary).build());
        }
