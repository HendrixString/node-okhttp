...
var FormEncodingBuilder = (function () {
    ...
    _createClass(FormEncodingBuilder, [{
        ...
        value: function add(name, value) {
            if (_query.length > 0) this[_query] += "&";
        ...
        value: function build() {
            return _RequestBody2.default.create(_query, new _MimeBuilder2.default().contentType("application/x-www-form-urlencoded").build());
        }
    }]);
