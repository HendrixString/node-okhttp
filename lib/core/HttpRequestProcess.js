...
var HttpRequestProcess = (function (_BaseWorker) {
    ...
    function HttpRequestProcess($request) {
        ...
        var $priorityKey = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];

        _classCallCheck(this, HttpRequestProcess);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HttpRequestProcess).call(this, $id, $priorityKey));
    ...
    _createClass(HttpRequestProcess, [{
        ...
        value: function process(onComplete, onError) {
            _get(Object.getPrototypeOf(HttpRequestProcess.prototype), 'process', this).call(this, onComplete, onError);
            ...
            var http_carrier = parsedUrl.protocol === 'https:' ? https : http;

            var headers = body ? Object.assign(request.headers, body.mimes) : Object.assign({}, request.headers);
        ...
        value: function stop() {
            ...
            _get(Object.getPrototypeOf(HttpRequestProcess.prototype), 'stop', this).call(this);
        }
        ...
        value: function dispose() {
            ...
            _get(Object.getPrototypeOf(HttpRequestProcess.prototype), 'dispose', this).call(this);
